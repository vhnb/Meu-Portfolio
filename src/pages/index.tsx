...
export default function Home() {
  ...
  return (
    <main className="flex items-center justify-start min-h-[calc(100vh-70px)] flex-col relative overflow-hidden">
      ...
      <div className="flex items-start justify-center w-[90%] max-w-[1000px] z-10 flex-col">
        <div className="flex items-center justify-center flex-row border-b border-[#b3b3b321]">
          <div className="flex items-start justify-center flex-col mr-[50px]">
            <TextAnimate animation="blurIn" as="h1" className="text-[22px] font-semibold mb-[10px] md:text-[20px]">
              Olá, sou Victor — Desenvolvedor Front-End.
            </TextAnimate>
            <TextAnimate animation="blurIn" as="p" className="text-[14px] text-[#b3b3b3] mb-[20px] md:text-[15px]">
