...
export default function CardPost({ id, title, desc }: ContentPost) {
    ...
    return (
        <article onClick={() => handleToPageDetail(id)} className="flex flex-col w-full cursor-pointer bg-[#030303] rounded-[10px] p-[14px] duration-[0.3s] border border-input border-[1px] hover:bg-[#0a0a0a]">
